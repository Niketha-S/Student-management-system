...
<head>
    ...
    <style> 
    body{background-image:url("https://wallpaperaccess.com/full/1567846.jpg");}
    table {
...
<body>
    ...
    <div class="container">
        <div class="details">
            ...
            <span>Registration No:</span> <?php echo $rn; ?> <br>
        </div>
    ...
    <button class="button-3" onclick="window.print()">Print Result</button>
